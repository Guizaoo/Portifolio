  ...
  useEffect(() => {
    ...
    const program = new Program(gl, {
      ...
      uniforms: {
        ...
        uColorStops: { value: colorsToRgb(colorStops) },
    ...
    const update = (frameTime) => {
      ...
      const shaderTime = current.time ?? frameTime * 0.01;

      program.uniforms.uTime.value = shaderTime * current.speed * 0.1;
      program.uniforms.uAmplitude.value = current.amplitude;
      program.uniforms.uBlend.value = current.blend;
      program.uniforms.uColorStops.value = colorsToRgb(current.colorStops);
